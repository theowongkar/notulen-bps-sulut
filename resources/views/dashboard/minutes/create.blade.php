<x-app-layout>
    ...
    {{-- Judul Halaman --}}
    <x-slot name="title">Tambah Notulen</x-slot>
    ...
    <section class="space-y-2">
        ...
        <div class="max-w-3xl mx-auto p-4 bg-white rounded-lg border border-gray-300 shadow">
            <h2 class="mb-5 font-semibold text-gray-700">Tambah Notulen</h2>
            ...
            <form action="{{ route('dashboard.minute.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 gap-4">
                    ...
                    <div>
                        ...
                        <input id="problem" value="{{ old('problem') }}" type="hidden" name="problem">
                    ...
                    <div>
                        ...
                        <input id="solution" value="{{ old('solution') }}" type="hidden" name="solution">
                    ...
                    <div>
                        <label for="follow_up_plan" class="block mb-1 text-sm font-medium text-gray-700">Rencana
                            Tindaklanjut</label>
                        <input id="follow_up_plan" value="{{ old('follow_up_plan') }}" type="hidden"
                            name="follow_up_plan">
                    ...
                    <div>
                        <label for="data_source" class="block mb-1 text-sm font-medium text-gray-700">Sumber
                            Data</label>
                        <input id="data_source" value="{{ old('data_source') }}" type="hidden" name="data_source">
                    ...
                    <div class="flex flex-col md:flex-row gap-4">
                        <div class="w-full">
                            <x-forms.select name="followed_up_by" label="Ditindaklanjuti oleh"
                                :options="$users->pluck('name', 'id')"></x-forms.select>
                        </div>
                        <div class="w-full">
                            <x-forms.input name="follow_up_limits" label="Batas Tindak Lanjut"
