        ...
        <div class="bg-gray-50 rounded-lg border border-gray-300 shadow">
            <div class="p-2 space-y-2">
                <div class="flex flex-col lg:flex-row items-center justify-between gap-4">
                    ...
                    {{-- Form Filter & Search --}}
                    <form method="GET" action="{{ route('dashboard.user.index') }}" class="w-full flex justify-end gap-1"
                        x-data="{ openFilter: '' }">
                        ...
                        <div class="w-full lg:w-80">
                            <x-forms.input type="text" name="search" placeholder="Cari nama pengguna..."
            ...
            <table class="min-w-full text-sm">
                <thead class="bg-gray-800 text-gray-50">
                    <tr>
                        ...
                        <th class="p-2 font-normal text-center border-r border-gray-600">Role</th>
